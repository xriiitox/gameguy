            ...
            switch (z) {
                ...
                case 5: // PUSH and various ops
                    if (q) { // CALL nn
                        ...
                        sp--;
                        bus[sp--] = (uint8_t)(*rp2[p]() >> 8);
                        bus[sp] = (uint8_t)*rp2[p]();
                        t_cycle += 16;
                    }
                    break;
